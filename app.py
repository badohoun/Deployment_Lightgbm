...
def main():
    ...
    if page == "HomePage":
        ...
        # Building phone position prediction app :
...
def link_scatter():
    chart = (
        alt.Chart(df.head(900)).mark_point().encode(
        x = "datetime",
        y= "norm_median",
        color = "activity",
        href = "https://www.youtube.com/watch?v=4L568emKOvs&t=48s:N",
        tooltip=["norm_max","https://www.youtube.com/watch?v=4L568emKOvs&t=48s:N"]
        )
        .interactive()
        .properties(width = 800 , height=750)
        .configure_legend(
            strokeColor="#ea4663",
            fillColor="#EEEEEE",
            padding=10,
